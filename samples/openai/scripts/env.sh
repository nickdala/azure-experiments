...
export PROJECT="openai-sample"
export RESOURCE_GROUP="rg-$PROJECT"
export TAG="openai-sample"
...
# CosmosDB
export COSMOSDB_DATABASE_NAME="db-$PROJECT"
export COSMOSDB_PASSWORD="password123!"
...
echo "COSMOSDB_PASSWORD=$COSMOSDB_PASSWORD"
